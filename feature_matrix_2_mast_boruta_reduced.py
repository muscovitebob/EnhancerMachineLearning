...
rfc=RandomForestClassifier(n_estimators=300,max_depth=None,min_samples_split=2)
...
X = data.drop(['id','_label'], axis=1).values
y = data['_label'].values
forest=RandomForestClassifier(n_estimators=300,max_depth=None,min_samples_split=2)
