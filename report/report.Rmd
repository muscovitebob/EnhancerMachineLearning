...
output:
  pdf_document:
    fig_caption: true
    pandoc_args: [--filter, ./pandoc-crossref.exe]
link-citations: yes
...
![featureImportances](pics/featureImportances.png){#fig:featureImportancs}
