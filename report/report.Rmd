...
The logos of the selected motifs are shown in [@fig:RFlogos]. 
They are then ordered by their relative importances as classifiers in the constructed RF model, as shown in [@fig:featureImportances].
